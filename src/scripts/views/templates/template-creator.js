...
function createRestoItemTemplate(resto) {
  return `
  <div class="restaurant-item">
    <div class="restaurant-item__header">
     <img  class="lazyload restaurant-item__header__poster" alt="${resto.name}"
           class="lazyload" data-src="${resto.pictureId ? CONFIG.BASE_IMAGE_URL + resto.pictureId : 'https://picsum.photos/id/666/800/450?grayscale'}">
...
function createRestoDetailTemplate(resto) {
  return `
